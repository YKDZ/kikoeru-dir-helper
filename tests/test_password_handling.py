...
def test_space_password_handling():
    ...
    try:
        ...
        test_cases = [
            ...
            ("test pass-(password with spaces).rar", "password with spaces", "test.rar"),
            
            # 混合密码 - 空格密码和普通密码
            ("RJ123456 pass-(first password) second.zip", "first password", "RJ123456 pass-second.zip"),
            ("test pass-simple (password with spaces).rar", "simple", "test pass-(password with spaces).rar"),
            
            # 多个空格密码
            ("RJ123456 pass-(password 1) (password 2).zip", "password 1", "RJ123456 pass-(password 2).zip"),
...
def test_password_parsing_internals():
    ...
    try:
        ...
        test_cases = [
            ...
            ("simple (password with spaces) final", ["simple", "password with spaces", "final"]),
    ...
    try:
        ...
        test_cases = [
            ...
            ("RJ123456 pass-(outer password) inner1 inner2.zip", 
             "outer password", "RJ123456 pass-inner1 inner2.zip"),
            
            # 第一层是普通密码，后续有空格密码
            ("test pass-outer (inner password) final.rar", 
             "outer", "test pass-(inner password) final.rar"),
            
            # 多个空格密码
            ("RJ123456 pass-(layer 1) (layer 2) (layer 3).7z", 
             "layer 1", "RJ123456 pass-(layer 2) (layer 3).7z"),
        ]
